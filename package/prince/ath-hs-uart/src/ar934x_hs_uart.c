...
static void ar934x_hs_uart_gpio(void)
{
	...
	// Enabling UART1_TD as outputs on GPIO
	...
	// Enabling UART1_TD as output on GPIO
...
#elif AR934X_HS_UART1_TX == 4
	data = ath_reg_rd(ATH_GPIO_OUT_FUNCTION1);
	data = (data & ~GPIO_OUT_FUNCTION1_ENABLE_GPIO_4_MASK) |
		ATH_GPIO_OUT_FUNCTION1_ENABLE_GPIO_4(GPIO_OUT_UART1_TD);
	ath_reg_wr(ATH_GPIO_OUT_FUNCTION1, data);
#elif AR934X_HS_UART1_TX == 3
	data = ath_reg_rd(ATH_GPIO_OUT_FUNCTION0);
	data = (data & ~GPIO_OUT_FUNCTION0_ENABLE_GPIO_3_MASK) |
		ATH_GPIO_OUT_FUNCTION0_ENABLE_GPIO_3(GPIO_OUT_UART1_TD);
	ath_reg_wr(ATH_GPIO_OUT_FUNCTION0, data);
#elif AR934X_HS_UART1_TX == 2
	data = ath_reg_rd(ATH_GPIO_OUT_FUNCTION0);
	data = (data & ~GPIO_OUT_FUNCTION0_ENABLE_GPIO_2_MASK) |
		ATH_GPIO_OUT_FUNCTION0_ENABLE_GPIO_2(GPIO_OUT_UART1_TD);
	ath_reg_wr(ATH_GPIO_OUT_FUNCTION0, data);
#elif AR934X_HS_UART1_TX == 1
	data = ath_reg_rd(ATH_GPIO_OUT_FUNCTION0);
	data = (data & ~GPIO_OUT_FUNCTION0_ENABLE_GPIO_1_MASK) |
		ATH_GPIO_OUT_FUNCTION0_ENABLE_GPIO_1(GPIO_OUT_UART1_TD);
	ath_reg_wr(ATH_GPIO_OUT_FUNCTION0, data);
#elif AR934X_HS_UART1_TX == 0
	data = ath_reg_rd(ATH_GPIO_OUT_FUNCTION0);
	data = (data & ~GPIO_OUT_FUNCTION0_ENABLE_GPIO_0_MASK) |
		ATH_GPIO_OUT_FUNCTION0_ENABLE_GPIO_0(GPIO_OUT_UART1_TD);
	ath_reg_wr(ATH_GPIO_OUT_FUNCTION0, data);
#endif
...
/*
	data = ath_reg_rd(ATH_GPIO_OUT_FUNCTION0);
	data = (data & ~GPIO_OUT_FUNCTION0_ENABLE_GPIO_3_MASK) |
		ATH_GPIO_OUT_FUNCTION0_ENABLE_GPIO_3(GPIO_OUT_SPI_CS_1);
	ath_reg_wr(ATH_GPIO_OUT_FUNCTION0, data);

	data = ath_reg_rd(ATH_GPIO_OUT_FUNCTION1);
	data = (data & ~GPIO_OUT_FUNCTION1_ENABLE_GPIO_4_MASK) |
		ATH_GPIO_OUT_FUNCTION1_ENABLE_GPIO_4(GPIO_OUT_SPI_CS_2);
	ath_reg_wr(ATH_GPIO_OUT_FUNCTION1, data);

	data = ath_reg_rd(ATH_GPIO_OE);
	data = data & (~(BIT(3) | BIT(4)));
	ath_reg_wr(ATH_GPIO_OE, data);
*/
	// Enabling UART1_RD as inputs on GPIO
	ath_reg_wr(ATH_GPIO_IN_ENABLE9, AR934X_HS_UART1_RX<<16);

	//set uart to default pin
	data = ath_reg_rd(ATH_GPIO_OE);
