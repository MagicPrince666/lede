...
const char *vendor = "XAG XlinkHS";
const char *model = "android.usbaoa";
const char *description = "xag Android AOA Interface";
const char *version = "xlinks_0.2";
const char *uri = "http://xa.com";
const char *serial = "xlinksxag2aoa";
